...
export const Editarserv = () => {
  ...
  const actualizarRegistro = async (objeto) => {
    //Envia el formulario
    try {
      await fetch(baseURL + "/servicios/actualizar", {
        method: "POST",
      ...
      >
        ...
        <section className={styles.formRadio}>
          <div className={styles.gpoentrada}>
            ...
            />
            {errors.serie?.type === "required" && <p>La Serie es necesaria</p>}
          ...
          <div className={styles.gpoentrada}>
            ...
            />
            {errors.marca?.type === "required" && <p>La Marca es necesaria</p>}
        ...
        <section className={styles.formUsuario}>
          ...
          <section className={styles.Datosdeusuario}>
            ...
            <div className={styles.gpoentrada}>
              ...
              {errors.ficha?.type === "max" && <p>El valor maximo es 999999</p>}
            </div>
          ...
          <section className={styles.Datosdeusuario}>
            <section className={styles.subdatosdeusuario}>
              <div className={styles.gpoentrada}>
                <label htmlFor="organismo_usuario" className={styles.etiqueta}>
                  Organismo
                </label>
                <select
                  className={styles.entradacorta}
        ...
        <section className={styles.formAdmonServ}>
          ...
          <div className={styles.Dadmongpo}>
            <div className={styles.gpoentrada}>
              ...
              />
              {errors.ctadmon?.type === "required" && <p>El CT es requerido</p>}
            ...
            <div className={styles.gpoentrada}>
              ...
              />
              {errors.clvctadmon?.type === "max" && <p>El valor max es 9999</p>}
            </div>
            <div className={styles.gpoentrada}>
